...
// Variables that store the minutes, seconds and milliseconds for playing
int min, sec, msec;
/*
...
/*
 * This function prints the value of the chrono. It does not receive the coor-
 * dinates where to plot the chrono display. It will always be plotted in the
...
/*
 * This function change the colors used to display the chronometer display. The
 * parameters are:
 * 		b = background color (that replaces to the default white)
 * 		c = digits color (that replaces to the default black)
 * The tiles of the chrono display are created out of two colors (black and
 * white) that are stored in two places in the palet. Changing this two
